...
export const userToClinicsTable = pgTable("users_to_clinics", {
  userId: text("user_id")
    .notNull()
...
export const doctorsTable = pgTable("doctors", {
  ...
  // 1 - Monday, 2 - Tuesday, 3 - Wednesday, 4 - Thursday, 5 - Friday, 6 - Saturday, 0 - Monday
  ...
  avaliableToTime: time("avaliable_from_time").notNull(),
...
export const patientBiologicalSexEnum = pgEnum("patient_biological_sex", [
  "male",
  "female",
]);
...
export const patientsTable = pgTable("patients", {
  ...
  biologicalSex: patientBiologicalSexEnum("biological_sex").notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at")
    .defaultNow()
    .$onUpdate(() => new Date()),
